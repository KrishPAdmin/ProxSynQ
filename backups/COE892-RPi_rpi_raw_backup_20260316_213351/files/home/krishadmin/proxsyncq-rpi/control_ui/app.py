...
def build_dashboard_payload():
    ...
    sync_events  = [serialize_row(r)   for r in recent_sync_events()]
    conflicts    = [serialize_row(r)   for r in recent_conflicts()]
    arb_actions  = [serialize_row(r)   for r in recent_arbiter_actions()]
    return {
